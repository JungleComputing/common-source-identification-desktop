...
import nl.minvenj.nfi.common_source_identification.filtergpu.*;
import nl.minvenj.nfi.common_source_identification.compare.PeakToCorrelationEnergy;
import nl.minvenj.nfi.common_source_identification.compare.NormalizedCrossCorrelation;
import nl.minvenj.nfi.common_source_identification.compare.PatternComparator;

import nl.minvenj.nfi.common_source_identification.Util;
...
/**
 * CommonSourceIdentificationGPU is an application for extracting and comparing PRNU filters.
 * 
 * @author Ben van Werkhoven <b.vanwerkhoven@esciencecenter.nl>
 * @version 0.2
 */
public class CommonSourceIdentificationGPU {
    ...
    */
    ...
    public static void main(final String[] args) throws IOException {
        ...
        if (args[0].equals("-single")) {
            ...
            new CommonSourceIdentificationGPU().run_single(args[1], args[2]);
            System.exit(0);
            ...
            new CommonSourceIdentificationGPU().run_all(args[1], args[2]);
            System.exit(0);
        }
        ...
        new CommonSourceIdentificationGPU().run(args[0], args[1], args[2]);
