 ...
 */
package nl.minvenj.nfi.common_source_identification.filtergpu;
...
import nl.minvenj.nfi.common_source_identification.CommonSourceIdentification;
import nl.minvenj.nfi.common_source_identification.Util;
import nl.minvenj.nfi.common_source_identification.filtergpu.WienerFilter;
...
public class WienerFilterTest {
	...
	public static void setUpBeforeClass() throws Exception {
		...
		long end = 0;
		BufferedImage image = Util.readImage(CommonSourceIdentification.INPUT_FILE);
		end = System.nanoTime();
	...
	public void computeVarianceZeroMeanTest() {
		...
		wienerFilter._sumFloats.launch(wienerFilter._stream, wienerFilter.sumfloats);
